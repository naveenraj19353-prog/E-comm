...
from app.services.whatsapp_notification_service import _message_for, process_notification
...
class WhatsAppNotificationTests(unittest.TestCase):
    ...
    def test_order_confirmation_is_sent(
        ...
        self.assertIn("https://demo.store.retailcosmos.com/orders", message)
    ...
    def test_public_product_image_sends_rich_media(
        ...
        self.assertIn(
            "https://demo.store.retailcosmos.com/orders",
            message,
        )
