...
const AddressCard = ({ address, selected, onSelect, onEdit, onDelete, isDeleting = false, }: AddressCardProps) => {
    return (<div className={`${styles.card} ${selected ? styles.selected : ""}`} onClick={onSelect}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.actions} onClick={(event) => event.stopPropagation()}>
          ...
          <button type="button" className={styles.deleteButton} disabled={isDeleting} onClick={onDelete}>
            <Trash2 size={14}/>
