...
const EditProfileModal = ({ profile, isUpdating, onClose, onSubmit, }: Props) => {
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.inputWrapper}>
              <User size={18}/>
              <input id="profile-name" type="text" value={name} onChange={(event) => setName(event.target.value)} placeholder="Enter your name"/>
            </div>
          </div>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.inputWrapper}>
              <Phone size={18}/>
              <input id="profile-phone" type="tel" value={phone} onChange={(event) => setPhone(event.target.value)} placeholder="Enter phone number"/>
            </div>
          </div>
