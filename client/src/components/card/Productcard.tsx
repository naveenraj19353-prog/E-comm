...
export default function ProductCard({
   ...
   * =========================================================
   * AVAILABLE COLORS
   * Only colors having stock > 0 are shown.
   * =========================================================
   */
   ...
   * No useEffect.
   *
   * If the user has selected a color and it still exists,
   * keep it.
   *
   ...
   * AVAILABLE SIZES
   *
   * Only sizes having stock > 0 for selected color.
   * =========================================================
   */
  ...
  const handleColorChange = (
    ...
    /*
     * Clear manually selected size.
     *
     * The derived selectedSize will automatically
     * become the first available size for this color.
     */
            ...
            <div className={styles.colorOptions}>
              {availableSizes.map((size) => (
                <button
                  ...
                  type="button"
                  className={`${styles.colorButton} ${
                    selectedSize === size ? styles.colorButtonActive : ""
                  }`}
