  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.brandColumn}>
          ...
          <p className={styles.tagline}>
            Defining the future of e-commerce with premium, curated experiences for modern brands
            and their customers.
          </p>
      ...
      <div className={styles.bottomBar}>
        <p className={styles.copyright}>© {year} Lunar Tech SaaS. All rights reserved.</p>
        <div className={styles.bottomLinks}>
          <button type="button" className={styles.bottomLinkButton}>
            <GlobeIcon />
            English (US)
          </button>
          <button type="button" className={styles.bottomLinkButton}>USD ($)</button>
        </div>
      </div>
    </footer>
  );
