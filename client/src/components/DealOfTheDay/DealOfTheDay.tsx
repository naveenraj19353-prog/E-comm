      ...
      <div className={styles.right}>
        <div className={styles.sliderHeader}>
          ...
          <div className={styles.arrows}>
            <button ref={prevRef} type="button" className={styles.arrowButton} aria-label="Previous deal">
              <ArrowIcon direction="left"/>
            </button>
            <button ref={nextRef} type="button" className={styles.arrowButton} aria-label="Next deal">
              <ArrowIcon direction="right"/>
            </button>
          </div>
        </div>
        <Swiper modules={[Navigation, Autoplay]} spaceBetween={18} slidesPerView={1} loop={products.length > 2} autoplay={{
            delay: 3500,
...
function ArrowIcon({ direction = "right" }) {
    ...
    return (<svg width="16" height="16" viewBox="0 0 24 24" fill="none" style={{ transform: rotate }} aria-hidden="true">
