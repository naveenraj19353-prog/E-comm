...
export default function AdminDashboard() {
    ...
    return (<div className={styles.page}>
      <header className={styles.header}>
        ...
        {!isAdmin ? (<button className={styles.createButton}>+ Create Tenant</button>) : ("")}
      </header>
      {!isAdmin ? (<section className={styles.stats}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.tenantList}>
          {visibleTenants.map((tenant) => (<div key={tenant._id} className={styles.tenant} onClick={() => {
