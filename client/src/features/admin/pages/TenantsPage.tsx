...
export default function TenantsPage() {
    ...
    const visibleTenants = isAdmin
        ? tenants.filter((tenant) => tenant.name?.trim().toLowerCase() ===
    ...
    return (<div className={styles.page}>
      ...
      <div className={styles.tableCard}>
        ...
        {visibleTenants.length === 0 ? (<div className={styles.empty}>
            ...
            <table className={styles.table}>
              ...
              <tbody>
                {visibleTenants.map((tenant) => (<tr key={tenant._id}>
                    <td>
      ...
      {showModal && (<div className={styles.modalOverlay} onMouseDown={(event) => {
          ...
          <div className={styles.modal}>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
              ...
              <div className={styles.field}>
                ...
                <input id="tenant-name" type="text" value={name} onChange={(event) => handleNameChange(event.target.value)} placeholder="Example: Tech World" required/>
              </div>
              ...
              <div className={styles.field}>
                ...
                .toLowerCase()
                .replace(/[^a-z0-9-]/g, ""))} placeholder="tech-world" required/>
              ...
              {createTenantMutation.isError && (<div className={styles.formError}>
                  Failed to create tenant. Please check the details and try
                  again.
                </div>)}
              
              <div className={styles.formActions}>
                <button type="button" className={styles.cancelButton} onClick={closeModal} disabled={createTenantMutation.isPending}>
                  Cancel
                </button>
                <button type="submit" className={styles.submitButton} disabled={createTenantMutation.isPending}>
