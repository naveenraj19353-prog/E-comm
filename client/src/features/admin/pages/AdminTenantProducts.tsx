      ...
      {editingProduct && (<div className={styles.modalOverlay} onMouseDown={(event) => {
          ...
          <div className={styles.modal}>
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                <label>Stock</label>
                <input type="number" min="0" value={editForm.stock} onChange={(event) => setEditForm({
                ...editForm,
              ...
              <div className={styles.formGroup}>
                <label>Sizes</label>
                <input placeholder="S, M, L, XL" value={editForm.sizes} onChange={(event) => setEditForm({
                ...editForm,
              ...
              <div className={styles.formGroup}>
                <label>Colors</label>
                <input placeholder="Black, Blue, Red" value={editForm.colors} onChange={(event) => setEditForm({
                ...editForm,
              ...
              <div className={`${styles.formGroup} ${styles.fullWidth}`}>
                ...
                {editForm.images.length > 0 && (<div className={styles.imagePreviewGrid}>
                    {editForm.images.map((image, index) => (<div key={`${image.slice(0, 30)}-${index}`} className={styles.imagePreview}>
